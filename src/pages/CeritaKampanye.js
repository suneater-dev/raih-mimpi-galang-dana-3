        ...
        <div className="form-group-modern">
          ...
          <div className="importance-section-modern">
            ...
            <div className="importance-content-modern">
              ...
              <p className="modern-text small">Dengan membuat cerita yang lengkap, kamu akan berkesempatan mendapatkan donasi yang lebih banyak</p>
            </div>
          </div>
