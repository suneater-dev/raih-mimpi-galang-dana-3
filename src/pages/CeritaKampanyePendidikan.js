...
const CeritaKampanyePendidikan = () => {
  ...
  const handleCreateStory = () => {
    navigate('/tulis-cerita-pendidikan', { state: previousData });
  };
        ...
        <div className="form-group-modern">
          ...
          <div className="importance-section-modern">
            ...
            <div className="importance-content-modern">
              ...
              <p className="modern-text small">Dengan membuat cerita yang lengkap tentang program bantuan pendidikan, kamu akan berkesempatan mendapatkan donasi yang lebih banyak</p>
            </div>
          </div>
...
export default CeritaKampanyePendidikan;